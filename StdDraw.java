...
/**
 * Standard draw. This class provides a basic capability for creating drawings
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * subsequent calls to drawing methods such as line(), circle(), and
     * square() will not be displayed on screen until the next call to show().
     ...
     * also speeds up drawing a huge number of shapes (call show(0) to defer
     * drawing on screen, draw the shapes, and call show(0) to display them all
     * on screen at once).
     *
     ...
     * drawing methods such as line(), circle(), and square() will be displayed
     * on screen when called. This is the default.
     */
     ...
     * KeyEvent.java for a description of key codes.
     *
